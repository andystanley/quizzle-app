...
public class QuestionBank {
    ...
    public void initDefaultQuestions(Context context) {
        ...
        if(allQuestions.isEmpty()) {
            ...
            // Create C++ Questions
            database.saveQuestion(new Question("1. Which of the following converts a type to a 64bit integer?", new String[]{"ToDecimal", "ToDouble", "ToInt64", "ToInt32"}, "ToInt64", "C++"));
            database.saveQuestion(new Question("2. Which of the following operator DOES NOT create a pointer to a variable in C#?", new String[]{"sizeof", "typeof", "&", "*"}, "sizeof", "C++"));
            database.saveQuestion(new Question("3. In which technique, can we refresh the dynamic content in android?", new String[]{"Javascript", "iOS", "Ajax", "None of the above"}, "Javascript", "C++"));
